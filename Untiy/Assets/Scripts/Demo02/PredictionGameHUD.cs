...
namespace BoomNetworkDemo
{
    ...
    /// </summary>
    [RequireComponent(typeof(PredictionPersonManager))]
    public class PredictionGameHUD : MonoBehaviour
    {
        private PredictionPersonManager _mgr;
        ...
        void Awake()
        {
            _mgr = GetComponent<PredictionPersonManager>();
        }
